...
TECHNO_IMG = "https://telegra.ph/file/0c17482c4bfa0fda3d360.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/theshashank")],
                                                                                   [InlineKeyboardButton(text="ADD WHITE DEVIL TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/theshashankk/whitedevilRoBoT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Yuss, Sur I'm Jinda")
